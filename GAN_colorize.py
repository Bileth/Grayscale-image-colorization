# -*- coding: utf-8 -*-
"""
Created on Sun Jan 23 14:17:26 2022
...
generator.save('train/my_model')

generator_saved = tf.keras.models.load_model('train/my_model/')

y = generator_saved( test_x[0 : ] ).numpy()
